...
public class ResidentClassificationWindow : Window, IComponentConnector
{
	...
	internal ComboBox colorComboBox;

	internal Border colorPreview;

	internal Border systemNotice;
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/baranggaysystem1;V3.0.0;component/views/dialogs/residentclassificationwindow.xaml", UriKind.Relative);
	...
	void IComponentConnector.Connect(int connectionId, object target)
	{
		...
		case 6:
			...
			break;
		case 7:
			descriptionTextBox = (TextBox)target;
			break;
		case 8:
			colorComboBox = (ComboBox)target;
			colorComboBox.SelectionChanged += ColorComboBox_SelectionChanged;
			break;
		case 9:
			colorPreview = (Border)target;
			break;
		case 10:
			systemNotice = (Border)target;
			break;
		case 11:
