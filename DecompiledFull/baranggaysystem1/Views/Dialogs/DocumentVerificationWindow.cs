...
public class DocumentVerificationWindow : Window, IComponentConnector
{
	...
	internal Border verificationStateBadge;

	internal TextBlock verificationStateText;

	internal TextBox lookupBox;

	internal TextBlock lookupHintText;

	internal Border resultCard;

	internal TextBlock resultSummaryText;

	internal TextBlock resultMetaText;

	internal TextBlock trackingCodeText;

	internal TextBlock documentNumberText;

	internal TextBlock residentNameText;

	internal TextBlock documentTypeText;

	internal TextBlock releasedOnText;

	internal TextBlock expiresOnText;

	internal TextBlock verificationTokenText;

	internal TextBlock paymentMetaText;

	internal TextBlock purposeText;

	internal TextBlock payloadText;

	internal TextBlock qrHelpText;

	internal Image qrImage;

	internal TextBlock qrEmptyText;

	internal TextBlock stateSummaryText;

	internal StackPanel emptyState;

	internal TextBlock emptyTitleText;

	internal TextBlock emptyMetaText;

	internal Button btnCopyToken;

	internal Button btnCopyPayload;
	...
	private static BitmapImage? CreateQrCode(string payload)
	{
		...
		try
		{
			QRCodeData val2 = val.CreateQrCode(payload, (ECCLevel)2, false, false, (EciMode)0, -1);
			try
			{
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/baranggaysystem1;V3.0.0;component/views/dialogs/documentverificationwindow.xaml", UriKind.Relative);
	...
	void IComponentConnector.Connect(int connectionId, object target)
	{
		...
		{
		case 1:
			verificationStateBadge = (Border)target;
			break;
		case 2:
			verificationStateText = (TextBlock)target;
			break;
		case 3:
			lookupBox = (TextBox)target;
			lookupBox.KeyDown += LookupBox_KeyDown;
			break;
		case 4:
			((Button)target).Click += BtnVerify_Click;
			break;
		case 5:
			lookupHintText = (TextBlock)target;
			break;
		case 6:
			resultCard = (Border)target;
			break;
		case 7:
			resultSummaryText = (TextBlock)target;
			break;
		case 8:
			resultMetaText = (TextBlock)target;
			break;
		case 9:
			trackingCodeText = (TextBlock)target;
			break;
		case 10:
			documentNumberText = (TextBlock)target;
			break;
		case 11:
			residentNameText = (TextBlock)target;
			break;
		case 12:
			documentTypeText = (TextBlock)target;
			break;
		case 13:
			releasedOnText = (TextBlock)target;
			break;
		case 14:
			expiresOnText = (TextBlock)target;
			break;
		case 15:
			verificationTokenText = (TextBlock)target;
			break;
		case 16:
			paymentMetaText = (TextBlock)target;
			break;
		case 17:
			purposeText = (TextBlock)target;
			break;
		case 18:
			payloadText = (TextBlock)target;
			break;
		case 19:
			qrHelpText = (TextBlock)target;
			break;
		case 20:
			qrImage = (Image)target;
			break;
		case 21:
			qrEmptyText = (TextBlock)target;
			break;
		case 22:
			stateSummaryText = (TextBlock)target;
			break;
		case 23:
			emptyState = (StackPanel)target;
			break;
		case 24:
			emptyTitleText = (TextBlock)target;
			break;
		case 25:
			emptyMetaText = (TextBlock)target;
			break;
		case 26:
			btnCopyToken = (Button)target;
			btnCopyToken.Click += BtnCopyToken_Click;
			break;
		case 27:
			btnCopyPayload = (Button)target;
