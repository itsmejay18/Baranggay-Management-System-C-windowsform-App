...
public class EllieAssistantWindow : Window, IComponentConnector
{
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/baranggaysystem1;V3.0.0;component/views/dialogs/ellieassistantwindow.xaml", UriKind.Relative);
