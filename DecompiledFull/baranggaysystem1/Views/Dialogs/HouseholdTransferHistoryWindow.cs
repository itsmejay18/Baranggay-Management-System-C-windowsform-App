...
public class HouseholdTransferHistoryWindow : Window, IComponentConnector
{
	...
	internal TextBlock householdTitleText;

	internal TextBlock historySummaryText;

	internal TextBlock timelineMetaText;

	internal DataGrid historyGrid;
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/baranggaysystem1;V3.0.0;component/views/dialogs/householdtransferhistorywindow.xaml", UriKind.Relative);
	...
	void IComponentConnector.Connect(int connectionId, object target)
	{
		...
		{
		case 1:
			householdTitleText = (TextBlock)target;
			break;
		case 2:
			historySummaryText = (TextBlock)target;
			break;
		case 3:
			timelineMetaText = (TextBlock)target;
			break;
		case 4:
			historyGrid = (DataGrid)target;
			break;
		case 5:
