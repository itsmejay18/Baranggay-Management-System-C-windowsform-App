...
public class GovernanceRegistryPage : UserControl, IComponentConnector
{
	...
	internal TextBlock totalAnnouncementsMetric;

	internal TextBlock publishedAnnouncementsMetric;

	internal TextBlock pinnedAnnouncementsMetric;

	internal TextBlock totalInitiativesMetric;

	internal TextBlock completedInitiativesMetric;
	...
	internal TabControl governanceTabs;

	internal TabItem announcementTab;

	internal DataGrid announcementGrid;

	internal StackPanel announcementEmptyState;

	internal TextBlock announcementEmptyLabel;

	internal TabItem projectTab;

	internal DataGrid projectGrid;

	internal StackPanel projectEmptyState;

	internal TextBlock projectEmptyLabel;
	...
	internal Button btnDeleteSelected;
	...
	private async void BtnAdd_Click(object sender, RoutedEventArgs e)
	{
		...
		else
		{
			...
			if (DialogService.Instance.ShowDialog(window2) == true)
			{
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/baranggaysystem1;V3.0.0;component/views/pages/governanceregistrypage.xaml", UriKind.Relative);
	...
	void IComponentConnector.Connect(int connectionId, object target)
	{
		...
		case 3:
			...
			break;
		case 4:
			totalAnnouncementsMetric = (TextBlock)target;
			break;
		case 5:
			publishedAnnouncementsMetric = (TextBlock)target;
			break;
		case 6:
			pinnedAnnouncementsMetric = (TextBlock)target;
			break;
		case 7:
			totalInitiativesMetric = (TextBlock)target;
			break;
		case 8:
			completedInitiativesMetric = (TextBlock)target;
			break;
		case 9:
		...
		case 12:
			...
			break;
		case 13:
			governanceTabs = (TabControl)target;
			governanceTabs.SelectionChanged += GovernanceTabs_SelectionChanged;
			break;
		case 14:
			announcementTab = (TabItem)target;
			break;
		case 15:
			announcementGrid = (DataGrid)target;
			announcementGrid.SelectionChanged += AnnouncementGrid_SelectionChanged;
			break;
		case 16:
			announcementEmptyState = (StackPanel)target;
			break;
		case 17:
			announcementEmptyLabel = (TextBlock)target;
			break;
		case 18:
			projectTab = (TabItem)target;
			break;
		case 19:
			projectGrid = (DataGrid)target;
			projectGrid.SelectionChanged += ProjectGrid_SelectionChanged;
			break;
		case 20:
			projectEmptyState = (StackPanel)target;
			break;
		case 21:
			projectEmptyLabel = (TextBlock)target;
			break;
		case 22:
		...
		case 26:
			...
			break;
		case 27:
			btnDeleteSelected = (Button)target;
