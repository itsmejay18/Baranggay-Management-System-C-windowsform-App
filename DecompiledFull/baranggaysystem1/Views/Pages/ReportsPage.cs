...
public class ReportsPage : UserControl, IComponentConnector
{
	...
	internal TextBlock rangeChip;

	internal TextBlock scopeChip;

	internal TextBlock lastRefreshChip;

	internal Button btnExportPdf;

	internal Button btnExportExcel;

	internal Button btnRefresh;

	internal TextBlock newResidentsValue;

	internal TextBlock certificateRequestsValue;

	internal TextBlock certificatesReleasedValue;

	internal TextBlock blottersFiledValue;

	internal DatePicker fromDatePicker;

	internal DatePicker toDatePicker;

	internal ComboBox purokFilterCombo;

	internal ComboBox certificateStatusCombo;

	internal ComboBox blotterStatusCombo;

	internal Button btnClearFilters;

	internal TextBlock filterSummaryLabel;

	internal TextBlock trendsMetaLabel;

	internal DataGrid trendsGrid;

	internal TextBlock snapshotMetaLabel;

	internal TextBlock totalResidentsValue;

	internal TextBlock pendingCertificatesValue;

	internal TextBlock activeBlottersValue;

	internal TextBlock topHotspotValue;

	internal TextBlock topHotspotMetaLabel;

	internal TextBlock serviceTimesMetaLabel;

	internal TextBlock approvalCycleValue;

	internal TextBlock approvalCycleMetaLabel;

	internal TextBlock releaseCycleValue;

	internal TextBlock releaseCycleMetaLabel;

	internal TextBlock hotspotMetaLabel;

	internal DataGrid hotspotGrid;

	internal TextBlock hotspotEmptyLabel;

	internal TextBlock staffMetaLabel;

	internal TextBlock staffCountLabel;

	internal DataGrid staffGrid;

	internal TextBlock staffEmptyLabel;

	internal TextBlock footerCountLabel;

	internal TextBlock footerStatusLabel;
	...
	private ReportsFilters BuildFilters()
	{
		...
		{
			PurokId = ((selectedPurokId > 0) ? new int?(selectedPurokId) : ((int?)null)),
	...
	private async Task ExportAsync(string formatName, string defaultExtension, string filter, Action<ReportsDashboardData, DateTime, DateTime, string> exportAction)
	{
		...
		try
		{
			...
			{
				exportAction(snapshot, from, to, dialog.FileName);
			});
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/baranggaysystem1;V3.0.0;component/views/pages/reportspage.xaml", UriKind.Relative);
	...
	void IComponentConnector.Connect(int connectionId, object target)
	{
		...
		case 1:
			...
			break;
		case 2:
			rangeChip = (TextBlock)target;
			break;
		case 3:
			scopeChip = (TextBlock)target;
			break;
		case 4:
			lastRefreshChip = (TextBlock)target;
			break;
		case 5:
			btnExportPdf = (Button)target;
			btnExportPdf.Click += BtnExportPdf_Click;
			break;
		case 6:
			btnExportExcel = (Button)target;
		...
		case 7:
			...
			break;
		case 8:
			newResidentsValue = (TextBlock)target;
			break;
		case 9:
			certificateRequestsValue = (TextBlock)target;
			break;
		case 10:
			certificatesReleasedValue = (TextBlock)target;
			break;
		case 11:
			blottersFiledValue = (TextBlock)target;
			break;
		case 12:
			fromDatePicker = (DatePicker)target;
			fromDatePicker.SelectedDateChanged += FilterDateChanged;
			break;
		case 13:
			toDatePicker = (DatePicker)target;
			toDatePicker.SelectedDateChanged += FilterDateChanged;
			break;
		case 14:
			purokFilterCombo = (ComboBox)target;
			purokFilterCombo.SelectionChanged += FilterCombo_SelectionChanged;
			break;
		case 15:
			certificateStatusCombo = (ComboBox)target;
			certificateStatusCombo.SelectionChanged += FilterCombo_SelectionChanged;
			break;
		case 16:
			blotterStatusCombo = (ComboBox)target;
			blotterStatusCombo.SelectionChanged += FilterCombo_SelectionChanged;
			break;
		case 17:
			btnClearFilters = (Button)target;
			btnClearFilters.Click += BtnClearFilters_Click;
			break;
		case 18:
			filterSummaryLabel = (TextBlock)target;
			break;
		case 19:
			trendsMetaLabel = (TextBlock)target;
			break;
		case 20:
			trendsGrid = (DataGrid)target;
			break;
		case 21:
			snapshotMetaLabel = (TextBlock)target;
			break;
		case 22:
			totalResidentsValue = (TextBlock)target;
			break;
		case 23:
			pendingCertificatesValue = (TextBlock)target;
			break;
		case 24:
			activeBlottersValue = (TextBlock)target;
			break;
		case 25:
			topHotspotValue = (TextBlock)target;
			break;
		case 26:
			topHotspotMetaLabel = (TextBlock)target;
			break;
		case 27:
			serviceTimesMetaLabel = (TextBlock)target;
			break;
		case 28:
			approvalCycleValue = (TextBlock)target;
			break;
		case 29:
			approvalCycleMetaLabel = (TextBlock)target;
			break;
		case 30:
			releaseCycleValue = (TextBlock)target;
			break;
		case 31:
			releaseCycleMetaLabel = (TextBlock)target;
			break;
		case 32:
			hotspotMetaLabel = (TextBlock)target;
			break;
		case 33:
			hotspotGrid = (DataGrid)target;
			break;
		case 34:
			hotspotEmptyLabel = (TextBlock)target;
			break;
		case 35:
			staffMetaLabel = (TextBlock)target;
			break;
		case 36:
			staffCountLabel = (TextBlock)target;
			break;
		case 37:
			staffGrid = (DataGrid)target;
			break;
		case 38:
			staffEmptyLabel = (TextBlock)target;
			break;
		case 39:
			footerCountLabel = (TextBlock)target;
			break;
		case 40:
			footerStatusLabel = (TextBlock)target;
			break;
		default:
			_contentLoaded = true;
			break;
