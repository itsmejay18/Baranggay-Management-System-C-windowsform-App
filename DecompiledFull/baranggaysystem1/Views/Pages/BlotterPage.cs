...
public class BlotterPage : UserControl, IComponentConnector
{
	...
	internal TextBlock headerActiveLabel;

	internal TextBlock headerTypeLabel;

	internal Button btnExportCsv;

	internal TextBlock totalCasesMetric;

	internal TextBlock visibleCasesMetric;

	internal TextBlock ongoingCasesMetric;

	internal TextBlock resolvedCasesMetric;
	...
	internal ComboBox caseTypeFilterCombo;
	...
	internal TextBlock selectedPartiesLabel;

	internal TextBlock selectedRecordMetaLabel;

	internal Button btnEditCase;

	internal Button btnResolve;

	internal Button btnReferral;
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/baranggaysystem1;V3.0.0;component/views/pages/blotterpage.xaml", UriKind.Relative);
	...
	void IComponentConnector.Connect(int connectionId, object target)
	{
		...
		case 2:
			...
			break;
		case 3:
			headerActiveLabel = (TextBlock)target;
			break;
		case 4:
			headerTypeLabel = (TextBlock)target;
			break;
		case 5:
		...
		case 6:
			...
			break;
		case 7:
			totalCasesMetric = (TextBlock)target;
			break;
		case 8:
			visibleCasesMetric = (TextBlock)target;
			break;
		case 9:
			ongoingCasesMetric = (TextBlock)target;
			break;
		case 10:
			resolvedCasesMetric = (TextBlock)target;
			break;
		case 11:
		...
		case 13:
			...
			timeFilterCombo.SelectionChanged += TimeFilter_SelectionChanged;
			break;
		case 14:
			caseTypeFilterCombo = (ComboBox)target;
			caseTypeFilterCombo.SelectionChanged += CaseTypeFilter_SelectionChanged;
			break;
		case 15:
			statusFilterCombo = (ComboBox)target;
			statusFilterCombo.SelectionChanged += StatusFilter_SelectionChanged;
			break;
		case 16:
		...
		case 25:
			...
			break;
		case 26:
			selectedPartiesLabel = (TextBlock)target;
			break;
		case 27:
			selectedRecordMetaLabel = (TextBlock)target;
			break;
		case 28:
			btnEditCase = (Button)target;
			btnEditCase.Click += BtnEdit_Click;
			break;
		case 29:
			btnResolve = (Button)target;
			btnResolve.Click += BtnEdit_Click;
			break;
		case 30:
			btnReferral = (Button)target;
			btnReferral.Click += BtnEdit_Click;
			break;
		case 31:
