...
public class AyudaPage : UserControl, IComponentConnector
{
	...
	internal TextBlock totalBudgetMetric;

	internal TextBlock spentBudgetMetric;

	internal TextBlock remainingBudgetMetric;

	internal TextBlock beneficiaryMetric;

	internal TextBox searchBox;

	internal ComboBox programFilter;

	internal ComboBox statusFilter;

	internal TextBlock programMetaLabel;

	internal TextBlock programTableVisibleLabel;

	internal TextBlock programTableSelectionLabel;

	internal DataGrid programGrid;

	internal StackPanel programEmptyState;

	internal TextBlock programEmptyLabel;

	internal TextBlock releaseMetaLabel;

	internal TextBlock releaseTableVisibleLabel;

	internal TextBlock releaseTableSelectionLabel;

	internal DataGrid releaseGrid;

	internal StackPanel releaseEmptyState;

	internal TextBlock releaseEmptyLabel;

	internal TextBlock footerCountLabel;

	internal TextBlock selectedProgramFooterLabel;
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/baranggaysystem1;V3.0.0;component/views/pages/ayudapage.xaml", UriKind.Relative);
	...
	void IComponentConnector.Connect(int connectionId, object target)
	{
		...
		case 1:
			...
			break;
		case 2:
			totalBudgetMetric = (TextBlock)target;
			break;
		case 3:
			spentBudgetMetric = (TextBlock)target;
			break;
		case 4:
			remainingBudgetMetric = (TextBlock)target;
			break;
		case 5:
			beneficiaryMetric = (TextBlock)target;
			break;
		case 6:
			((Button)target).Click += BtnAddProgram_Click;
			break;
		case 7:
			((Button)target).Click += BtnReleaseAyuda_Click;
			break;
		case 8:
			...
			break;
		case 9:
			programFilter = (ComboBox)target;
			programFilter.SelectionChanged += Filter_SelectionChanged;
			break;
		case 10:
		...
		case 11:
			...
			break;
		case 12:
			programMetaLabel = (TextBlock)target;
			break;
		case 13:
			programTableVisibleLabel = (TextBlock)target;
			break;
		case 14:
			programTableSelectionLabel = (TextBlock)target;
			break;
		case 15:
			programGrid = (DataGrid)target;
			programGrid.SelectionChanged += ProgramGrid_SelectionChanged;
			break;
		case 16:
			programEmptyState = (StackPanel)target;
			break;
		case 17:
			programEmptyLabel = (TextBlock)target;
			break;
		case 18:
			releaseMetaLabel = (TextBlock)target;
			break;
		case 19:
			releaseTableVisibleLabel = (TextBlock)target;
			break;
		case 20:
			releaseTableSelectionLabel = (TextBlock)target;
			break;
		case 21:
			releaseGrid = (DataGrid)target;
			releaseGrid.SelectionChanged += ReleaseGrid_SelectionChanged;
			break;
		case 22:
			releaseEmptyState = (StackPanel)target;
			break;
		case 23:
			releaseEmptyLabel = (TextBlock)target;
			break;
		case 24:
			footerCountLabel = (TextBlock)target;
			break;
		case 25:
			((Button)target).Click += BtnEditProgram_Click;
			break;
		case 26:
			((Button)target).Click += BtnDeleteProgram_Click;
			break;
		case 27:
			((Button)target).Click += BtnEditRelease_Click;
			break;
		case 28:
			((Button)target).Click += BtnDeleteRelease_Click;
			break;
		case 29:
			((Button)target).Click += BtnOpenReport_Click;
			break;
		case 30:
			selectedProgramFooterLabel = (TextBlock)target;
			break;
		default:
			_contentLoaded = true;
			break;
