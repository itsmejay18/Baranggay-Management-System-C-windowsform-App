...
public class PaymentsPage : UserControl, IComponentConnector
{
	...
	internal ComboBox methodFilter;
	...
	internal Button btnPrintOR;

	internal Button btnViewDetails;
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/baranggaysystem1;V3.0.0;component/views/pages/paymentspage.xaml", UriKind.Relative);
	...
	void IComponentConnector.Connect(int connectionId, object target)
	{
		...
		case 4:
			...
			break;
		case 5:
			methodFilter = (ComboBox)target;
			methodFilter.SelectionChanged += Filter_SelectionChanged;
			break;
		case 6:
		...
		case 11:
			...
			break;
		case 12:
			btnPrintOR = (Button)target;
			btnPrintOR.Click += BtnPrintOR_Click;
			break;
		case 13:
			btnViewDetails = (Button)target;
			btnViewDetails.Click += BtnView_Click;
			break;
		case 14:
			btnVoid = (Button)target;
