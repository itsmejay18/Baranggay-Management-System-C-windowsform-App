...
public class StaffManagementPage : UserControl, IComponentConnector
{
	...
	internal Button btnEditStaff;

	internal Button btnResetPw;
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/baranggaysystem1;V3.0.0;component/views/pages/staffmanagementpage.xaml", UriKind.Relative);
	...
	void IComponentConnector.Connect(int connectionId, object target)
	{
		...
		case 9:
			...
			break;
		case 10:
			btnEditStaff = (Button)target;
			btnEditStaff.Click += BtnEdit_Click;
			break;
		case 11:
			btnResetPw = (Button)target;
			btnResetPw.Click += BtnResetPassword_Click;
			break;
		case 12:
			btnDeactivate = (Button)target;
			btnDeactivate.Click += BtnDelete_Click;
			break;
		case 13:
