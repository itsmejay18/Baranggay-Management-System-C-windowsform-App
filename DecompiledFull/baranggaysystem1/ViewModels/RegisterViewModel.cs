...
public sealed class RegisterViewModel : ViewModelBase
{
	...
	[GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.RelayCommandGenerator", "8.3.0.0")]
	private RelayCommand? removePhotoCommand;

	[GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.RelayCommandGenerator", "8.3.0.0")]
	private RelayCommand? backToLoginCommand;

	[GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.RelayCommandGenerator", "8.3.0.0")]
	private AsyncRelayCommand<string>? registerCommand;
	...
	public string Username
	{
		...
		set
		{
			((ObservableObject)this).SetProperty<string>(ref _username, value, "Username");
		}
	}
	...
	public string ErrorMessage
	{
		...
		set
		{
			((ObservableObject)this).SetProperty<string>(ref _errorMessage, value, "ErrorMessage");
	...
	public bool HasError
	{
		...
		set
		{
			((ObservableObject)this).SetProperty<bool>(ref _hasError, value, "HasError");
		}
	}
	...
	public string? PhotoPath
	{
		...
		set
		{
			((ObservableObject)this).SetProperty<string>(ref _photoPath, value, "PhotoPath");
		}
	}
	...
	public string SelectedRole
	{
		...
		set
		{
			((ObservableObject)this).SetProperty<string>(ref _selectedRole, value, "SelectedRole");
		}
	}
	...
	public IRelayCommand UploadPhotoCommand
	{
		get
		{
			...
			RelayCommand obj = uploadPhotoCommand;
			if (obj == null)
			{
				RelayCommand val = new RelayCommand((Action)UploadPhoto);
				RelayCommand val2 = val;
				uploadPhotoCommand = val;
				obj = val2;
			}
	...
	[GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.RelayCommandGenerator", "8.3.0.0")]
	[ExcludeFromCodeCoverage]
	public IRelayCommand RemovePhotoCommand
	{
		get
		{
			//IL_0017: Unknown result type (might be due to invalid IL or missing references)
			...
			//IL_001e: Expected O, but got Unknown
			//IL_0023: Expected O, but got Unknown
			RelayCommand obj = removePhotoCommand;
			if (obj == null)
			{
				RelayCommand val = new RelayCommand((Action)RemovePhoto);
				RelayCommand val2 = val;
				removePhotoCommand = val;
				obj = val2;
			}
			return (IRelayCommand)(object)obj;
		}
	...
	[GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.RelayCommandGenerator", "8.3.0.0")]
	[ExcludeFromCodeCoverage]
	public IRelayCommand BackToLoginCommand
	{
		get
		{
			//IL_0017: Unknown result type (might be due to invalid IL or missing references)
			...
			//IL_001e: Expected O, but got Unknown
			//IL_0023: Expected O, but got Unknown
			RelayCommand obj = backToLoginCommand;
			if (obj == null)
			{
				RelayCommand val = new RelayCommand((Action)BackToLogin);
				RelayCommand val2 = val;
				backToLoginCommand = val;
				obj = val2;
			}
			return (IRelayCommand)(object)obj;
		}
	...
	[GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.RelayCommandGenerator", "8.3.0.0")]
	[ExcludeFromCodeCoverage]
	public IAsyncRelayCommand<string> RegisterCommand => (IAsyncRelayCommand<string>)(object)(registerCommand ?? (registerCommand = new AsyncRelayCommand<string>((Func<string, Task>)RegisterAsync)));
