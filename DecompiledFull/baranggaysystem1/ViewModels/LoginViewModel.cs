...
public sealed class LoginViewModel : ViewModelBase
{
	...
	public IAsyncRelayCommand<string> LoginCommand => (IAsyncRelayCommand<string>)(object)(loginCommand ?? (loginCommand = new AsyncRelayCommand<string>((Func<string, Task>)LoginAsync)));
	...
	public IRelayCommand RegisterCommand
	{
		get
		{
			...
			RelayCommand obj = registerCommand;
			if (obj == null)
			{
				RelayCommand val = new RelayCommand((Action)Register);
