...
internal static class ReportsExportService
{
	...
	private static void WriteSummarySheet(IXLWorkbook wb, ReportsDashboardData data, DateTime from, DateTime to)
	{
		...
		obj.Cell(1, 1).Value = XLCellValue.op_Implicit("Barangay System Reports");
		((IXLFontBase)obj.Cell(1, 1).Style.Font).Bold = true;
		((IXLFontBase)obj.Cell(1, 1).Style.Font).FontSize = 16.0;
		obj.Cell(2, 1).Value = XLCellValue.op_Implicit("Date range:");
		obj.Cell(2, 2).Value = XLCellValue.op_Implicit($"{from:yyyy-MM-dd} to {to:yyyy-MM-dd}");
		obj.Cell(4, 1).Value = XLCellValue.op_Implicit("Summary");
		...
		num++;
		obj.Cell(num, 1).Value = XLCellValue.op_Implicit("Service times");
		((IXLFontBase)obj.Cell(num, 1).Style.Font).Bold = true;
		num++;
		obj.Cell(num, 1).Value = XLCellValue.op_Implicit("Avg request -> approval");
		obj.Cell(num, 2).Value = XLCellValue.op_Implicit(FormatDuration(data.ServiceTimes.AvgRequestToApprovalSeconds));
		obj.Cell(num, 3).Value = XLCellValue.op_Implicit($"Samples: {data.ServiceTimes.ApprovalSamples}");
		num++;
		obj.Cell(num, 1).Value = XLCellValue.op_Implicit("Avg approval -> release");
		obj.Cell(num, 2).Value = XLCellValue.op_Implicit(FormatDuration(data.ServiceTimes.AvgApprovalToReleaseSeconds));
		obj.Cell(num, 3).Value = XLCellValue.op_Implicit($"Samples: {data.ServiceTimes.ReleaseSamples}");
	...
	private static void WriteTrendsSheet(IXLWorkbook wb, ReportsDashboardData data)
	{
		...
		val.Cell(1, 1).Value = XLCellValue.op_Implicit("Month");
		val.Cell(1, 2).Value = XLCellValue.op_Implicit("Residents");
		val.Cell(1, 3).Value = XLCellValue.op_Implicit("Certificates");
		val.Cell(1, 4).Value = XLCellValue.op_Implicit("Blotter");
		...
		{
			val.Cell(num, 1).Value = XLCellValue.op_Implicit(item.MonthLabel);
			val.Cell(num, 2).Value = XLCellValue.op_Implicit(item.Residents);
			val.Cell(num, 3).Value = XLCellValue.op_Implicit(item.Certificates);
			val.Cell(num, 4).Value = XLCellValue.op_Implicit(item.Blotters);
			num++;
		}
	...
	private static void WriteStaffSheet(IXLWorkbook wb, ReportsDashboardData data)
	{
		...
		{
			val.Cell(1, i + 1).Value = XLCellValue.op_Implicit(array[i]);
		}
		...
		{
			val.Cell(num, 1).Value = XLCellValue.op_Implicit(item.User);
			val.Cell(num, 2).Value = XLCellValue.op_Implicit(item.Completed);
			val.Cell(num, 3).Value = XLCellValue.op_Implicit(item.Overdue);
			val.Cell(num, 4).Value = XLCellValue.op_Implicit(item.ApprovalsCompleted);
			val.Cell(num, 5).Value = XLCellValue.op_Implicit(item.ApprovalsOverdue);
			val.Cell(num, 6).Value = XLCellValue.op_Implicit(item.AvgApproval);
			val.Cell(num, 7).Value = XLCellValue.op_Implicit(item.ReleasesCompleted);
			val.Cell(num, 8).Value = XLCellValue.op_Implicit(item.ReleasesOverdue);
			val.Cell(num, 9).Value = XLCellValue.op_Implicit(item.AvgRelease);
			val.Cell(num, 10).Value = XLCellValue.op_Implicit(item.BlotterStatusChanges);
			val.Cell(num, 11).Value = XLCellValue.op_Implicit(item.BlotterResolutions);
			val.Cell(num, 12).Value = XLCellValue.op_Implicit(item.BlotterResolutionsOverdue);
			val.Cell(num, 13).Value = XLCellValue.op_Implicit(item.AvgResolution);
			num++;
		}
		val.Columns().AdjustToContents();
		val.SheetView.FreezeRows(1);
	...
	private static void WriteHotspotsSheet(IXLWorkbook wb, ReportsDashboardData data)
	{
		...
		val.Cell(1, 1).Value = XLCellValue.op_Implicit("Purok");
		val.Cell(1, 2).Value = XLCellValue.op_Implicit("Incidents");
		val.Cell(1, 3).Value = XLCellValue.op_Implicit("Latitude");
		val.Cell(1, 4).Value = XLCellValue.op_Implicit("Longitude");
		val.Cell(1, 5).Value = XLCellValue.op_Implicit("Coordinates");
		...
		{
			val.Cell(num, 1).Value = XLCellValue.op_Implicit(item.PurokName);
			val.Cell(num, 2).Value = XLCellValue.op_Implicit(item.IncidentCount);
			if (item.Latitude.HasValue)
			{
				val.Cell(num, 3).Value = XLCellValue.op_Implicit(item.Latitude.Value);
			}
			else
			{
				val.Cell(num, 3).Value = XLCellValue.op_Implicit(string.Empty);
			}
			if (item.Longitude.HasValue)
			{
				val.Cell(num, 4).Value = XLCellValue.op_Implicit(item.Longitude.Value);
			}
			else
			{
				val.Cell(num, 4).Value = XLCellValue.op_Implicit(string.Empty);
			}
			val.Cell(num, 5).Value = XLCellValue.op_Implicit((item.Latitude.HasValue && item.Longitude.HasValue) ? $"{item.Latitude.Value:0.0000}, {item.Longitude.Value:0.0000}" : "Not mapped");
			num++;
		}
		val.Columns().AdjustToContents();
		val.SheetView.FreezeRows(1);
	...
	private static void WriteKeyValue(IXLWorksheet ws, int row, string key, int value)
	{
		...
		ws.Cell(row, 1).Value = XLCellValue.op_Implicit(key);
		ws.Cell(row, 2).Value = XLCellValue.op_Implicit(value);
	}
