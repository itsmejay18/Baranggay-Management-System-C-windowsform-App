...
--
-- Table structure for table `document_number_sequence`
--
...
--
-- Dumping data for table `document_number_sequence`
--

LOCK TABLES `document_number_sequence` WRITE;
/*!40000 ALTER TABLE `document_number_sequence` DISABLE KEYS */;
/*!40000 ALTER TABLE `document_number_sequence` ENABLE KEYS */;
UNLOCK TABLES;
