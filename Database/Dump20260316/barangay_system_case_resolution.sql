...
DROP TABLE IF EXISTS `case_resolution`;
...
CREATE TABLE `case_resolution` (
  ...
  `details` text,
  `signed_by_official_id` int DEFAULT NULL,
  PRIMARY KEY (`resolution_id`),
  KEY `case_id` (`case_id`),
  KEY `signed_by_official_id` (`signed_by_official_id`),
...
LOCK TABLES `case_resolution` WRITE;
/*!40000 ALTER TABLE `case_resolution` DISABLE KEYS */;
/*!40000 ALTER TABLE `case_resolution` ENABLE KEYS */;
UNLOCK TABLES;
