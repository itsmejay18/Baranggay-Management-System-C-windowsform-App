...
DROP TABLE IF EXISTS `official_term`;
...
LOCK TABLES `official_term` WRITE;
/*!40000 ALTER TABLE `official_term` DISABLE KEYS */;
/*!40000 ALTER TABLE `official_term` ENABLE KEYS */;
UNLOCK TABLES;
