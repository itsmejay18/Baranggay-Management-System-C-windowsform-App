...
public partial class HouseholdsPage : UserControl
{
	...
	private void ApplyFilters()
	{
		...
		if (_data == null)
		{
			UpdateInsights((IReadOnlyCollection<DataRowView>)(object)Array.Empty<DataRowView>(), 0, 0);
			return;
		}
		...
		UpdateInsights((IReadOnlyCollection<DataRowView>)(object)array, count, distinctPurokCount);
	}
